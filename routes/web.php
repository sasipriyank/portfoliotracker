...
Route::post('searchposts', 'ApiHandlerController@showPosts');
Route::post('/ApiHandlerController/getCompanies/','ApiHandlerController@getCompanies')->name('ApiHandlerController.getCompanies');
